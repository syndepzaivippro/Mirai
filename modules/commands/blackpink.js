...
module.exports.config = {
  ...
  version: "1.0.0",
  hasPermssion: 0,
  credits: "HungCho (fix lại by CHIP)",
...
"https://i.imgur.com/DvEWRgb.jpg",
   ...
   var callback = () => api.sendMessage({body:`Ảnh Của Nhóm Blackpink+ \nSố Ảnh: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));  
